function mle(theta::AbstractArray, df0::DataFrame, df1::DataFrame, Xs::DataFrame, quad::AbstractArray, constants::Array)
    ...
    Ni0 = constants[3]
    Ni1 = constants[4]
    σ = exp.(theta[11:20]) #the first T are σ0, one for each t. the last Ts are for σ1.
    σw = σ[2*T+1]
    σt = σ[2*T+2]
    β0 = theta[1:4]
    β1 = theta[5:8]
    ...
    sel0 = [Xs0.xsa Xs0.xsbdiff Xs0.xsb2diff Xs0.xsc]*(β1-β0) .- [Xs0.za Xs0.zb Xs0.zd Xs0.ze Xs0.zf Xs0.zg]*δz
    sel1 = [Xs1.xsa Xs1.xsbdiff Xs1.xsb2diff Xs1.xsc]*(β1-β0) .- [Xs1.za Xs1.zb Xs1.zd Xs1.ze Xs1.zf Xs1.zg]*δz
